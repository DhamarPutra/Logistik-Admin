            ...
            <div id="content">
                ...
                <div id="page">
                    <div class="container-fluid d-flex justify-content-between">
                        ...
                        <a href="register"><button class="btn btn-info" type="button" style="background-color: #28a745;color:aliceblue" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="fas fa-plus-circle icon-add"></i>Add User</button></a>
                    </div>
                    <!-- /.container-fluid -->
                            ...
                            <div class="col-12 ">
                                <div class="card my-4">
                                    <div class="card-body px-0 pb-2  ">
                                        <div class="table-responsive p-0 overflow-y-auto height-300 ">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button class="btn btn-info" type="submit" style="background-color: #17a2b8;color:aliceblue" data-bs-toggle="modal" data-bs-target="#exampleModal2"><i class="fas fa-edit"></i> Edit</button>

                                                            <button class="btn btn-info" type="submit" style="background-color: red;color:aliceblue"><i class="fas fa-trash icon-delete"></i></i>
                                                                Delete</button>
                                                        </td>
                                                    </tr>
                                                    @endforeach
