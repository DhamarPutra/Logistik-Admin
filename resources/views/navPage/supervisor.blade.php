...
<body id="page-top"><!-- Page Wrapper -->
    <div id="wrapper"> <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar"><!-- Sidebar - Brand -->
            ...
            <div class="sidebar-heading">User</div><!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="page">
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="exportData" class="d-none d-sm-inline-block btn btn-sm shadow-sm text-white" style="background-color: blue">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">233
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">483</div>
                                            </div>
                                            <div class="col-auto">
